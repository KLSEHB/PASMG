...
class RobertaClassificationHead(nn.Module):
    def __init__(self, config):
        super().__init__()
        self.dense1 = nn.Linear(768*3, 512)
...
class Model_3(RobertaForSequenceClassification):
    ...
    def forward(self, input_ids1, input_ids2, input_ids3, labels=None):
        ...
        combined = torch.cat([cls1, cls2, cls3], dim=1)
