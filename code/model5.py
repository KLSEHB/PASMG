...
class RobertaClassificationHead(nn.Module):
    def __init__(self, config):
        super().__init__()
        self.dense1 = nn.Linear(768*5, 512)
...
class Model_5(RobertaForSequenceClassification):
    ...
    def forward(self, input_ids1, input_ids2, input_ids3, input_ids4, input_ids5, labels=None):
        ...
        combined = torch.cat([cls1, cls2, cls3, cls4, cls5], dim=1)
