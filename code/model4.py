...
class RobertaClassificationHead(nn.Module):
    def __init__(self, config):
        super().__init__()
        self.dense1 = nn.Linear(768*4, 512)
...
class Model_4(RobertaForSequenceClassification):
    ...
    def forward(self, input_ids1, input_ids2, input_ids3, input_ids4, labels=None):
        ...
        combined = torch.cat([cls1, cls2, cls3, cls4], dim=1)
